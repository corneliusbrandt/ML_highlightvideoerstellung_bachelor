...
def run_train_and_eval_RF_binary(debug=False):
    print("Running train_and_eval_RF_binary...")
    # Data preparation
    batch_size = 32
    num_classes = 2
    num_channels = 27
    ...
    best_cnn_path = r"src\Models\CNN_RF\CNN_RF_binary.pth"
    best_rf_path = r"src\Models\CNN_RF\RF_binary.pkl"
...
if __name__ == "__main__":
    run_train_and_eval_RF_binary(debug=True)
